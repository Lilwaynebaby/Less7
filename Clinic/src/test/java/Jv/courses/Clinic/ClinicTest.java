...
public class ClinicTest {
    ...
    public void testSearch() throws Exception {
        ...
        /**
         * Search by the name of the owner of a non-existent
         */
        clinic.search("Kosterin","1");
        Assert.assertFalse(clinic.inList);

        /**
         * Search by the name of the pet of a non-existent
         */
        clinic.search("Arsik","2");
        Assert.assertFalse(clinic.inList);
